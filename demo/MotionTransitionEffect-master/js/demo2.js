 ...
 */
{
	...
	class Slideshow {
		...
		navigate(direction = 'next') {
			...
			// 在GreenSock 2.0后，Power0取代了Linear，Power1取代了Quad，Power2取代了Cubic，Power3取代了Quart，Power4取代了Quint/Strong。
			this.tl
	...
	imagesLoaded(document.querySelectorAll('.slide__image'), {background: true}, () => document.querySelector('main').classList.remove('loading'));
}
